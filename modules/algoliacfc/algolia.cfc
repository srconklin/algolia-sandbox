...
component output="false" displayname="algolia.cfc"  {
  ...
  */
  ...
  /**
  * https://www.algolia.com/doc/rest-api/search/#clear-index
  * @hint This function deletes the index . Settings and index specific API keys are kept untouched.
  */
  public struct function deleteIndex( required string indexName ) {
    return apiCall( false, 'DELETE', '/indexes/#indexName#/delete' );
  }

  /**
  * https://www.algolia.com/doc/rest-api/search/#change-index-settings
  * @hint Set settings for this index.
  * Documentation states that "Specifying null for a setting resets it to its default value." This is not true for all settings. For example, 'hitsPerPage' requires a value. 
  * I don't have have a list of settings that require values.
